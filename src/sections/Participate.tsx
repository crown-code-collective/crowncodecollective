...
const PATHS = [
  ...
  {
    title: "Supporters",
    body: "Support the work through partnerships, sponsorships, volunteering, advocacy, or a tax-deductible gift. Crown Code Collective is a 501(c)(3) nonprofit organization, EIN 39-4418635.",
